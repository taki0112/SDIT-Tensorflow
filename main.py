from SDIT import SDIT
import argparse
from utils import *

"""parsing and configuration"""
def parse_args():
    desc = "Tensorflow implementation of SDIT"
    parser = argparse.ArgumentParser(description=desc)
    parser.add_argument('--phase', type=str, default='train', help='train or test ?')
    parser.add_argument('--attention', type=str2bool, default=True, choices=[True, False])
    ...
    parser.add_argument('--noise_weight', type=float, default=800, help='weight of noise for reconstruction loss')
    ...
    parser.add_argument('--label_list', type=str, nargs='+', help='selected attributes for the CelebA dataset',
                        default=['Blond_Hair', 'Brown_Hair', 'Male', 'Eyeglasses', 'Bangs'])
